...
!(function (e, t) {
      ...
      update: {
        ...
        updateSlides: function () {
          ...
          if (void 0 !== r) {
            ...
            for (
              var M, z, P, k = i.slidesPerColumn, $ = T / k, L = Math.floor(u / i.slidesPerColumn), I = 0;
              I < u;
              I += 1
            ) {
              C = 0;
              ...
              if ("none" !== O.css("display")) {
                if ("auto" === i.slidesPerView) {
                  ...
                  if (
                    (R && (O[0].style.transform = "none"), Y && (O[0].style.webkitTransform = "none"), i.roundLengths)
                  )
  ...
  var q = {
      update: function (e) {
        ...
        if ((S(t.virtual, { from: y, to: E, offset: x, slidesGrid: t.slidesGrid }), p === y && u === E && !e))
